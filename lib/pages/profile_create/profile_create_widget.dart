      ...
      body: SafeArea(
        ...
        child: Padding(
          ...
          child: FutureBuilder<ApiCallResponse>(
            future: CreateProfilesCall.call(
              name: _model.userNameTextController.text,
              birth: _model.userBirthTextController.text,
              height: double.tryParse(_model.userHeightTextController.text),
              weight: double.tryParse(_model.userWeightTextController.text),
              sex: _model.genderValue,
              nickname: _model.userNicknameTextController.text,
            ),
            builder: (context, snapshot) {
              ...
              final formCreateProfilesResponse = snapshot.data!;
              return Form(
                key: _model.formKey,
                        ...
                        Padding(
                          ...
                          child: TextFormField(
                            ...
                            decoration: InputDecoration(
                              ...
                              contentPadding: const EdgeInsetsDirectional.fromSTEB(
                                  20.0, 24.0, 0.0, 24.0),
                              suffixIcon: _model.userNicknameTextController!
                                      .text.isNotEmpty
                                  ? InkWell(
                                      onTap: () async {
                                        _model.userNicknameTextController
                            ...
                            validator: _model
                                .userNicknameTextControllerValidator
                                .asValidator(context),
                          ),
                        ),
                        Padding(
                          ...
                          child: TextFormField(
                            ...
                            validator: _model.userBirthTextControllerValidator
                                .asValidator(context),
                            inputFormatters: [_model.userBirthMask],
                          ),
                        ),
                        Padding(
                          padding: const EdgeInsetsDirectional.fromSTEB(
                              ...
                              onPressed: () async {
                                ...
                                _model.apiResultCreateProfile =
                                  ...
                                  birth: UserStruct.maybeFromMap(
                                          formCreateProfilesResponse.jsonBody)
                                      ?.birth
                                      ?.toString(),
