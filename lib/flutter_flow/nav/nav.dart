      ...
      routes: [
        ...
        FFRoute(
          ...
          builder: (context, params) => params.isEmpty
              ? const NavBarPage(initialPage: 'search_main')
        ...
        FFRoute(
          ...
          path: '/calenderMain',
          builder: (context, params) => params.isEmpty
              ? const NavBarPage(initialPage: 'calender_main')
              : const CalenderMainWidget(),
        ),
        FFRoute(
          name: 'profile',
          path: '/profile',
        ...
        FFRoute(
          name: 'login_sample',
          path: '/loginSample',
          builder: (context, params) => const LoginSampleWidget(),
        ),
        FFRoute(
          name: 'chating',
          path: '/chating',
          builder: (context, params) => const ChatingWidget(),
        ),
        FFRoute(
          name: 'gallery',
          path: '/gallery',
        ...
        FFRoute(
          name: 'chating_history',
          path: '/chatingHistory',
          builder: (context, params) => const ChatingHistoryWidget(),
        ),
        FFRoute(
          name: 'entryPage',
          path: '/entryPage',
